...
Each chapter follows the **Tell, Show, Do** structure:
...
- [Chapter 4 — Breaking Projects into Issues](./chapters/04-issues/README.md)
- [Chapter 5 — Labels, Milestones, and Shared Language](./chapters/05-organization/README.md)
- [Chapter 6 — Creating Your Project Board](./chapters/06-project-board/README.md)

### Part 3: Building and Collaborating
- [Chapter 7 — Managing Issues with Perplexity](./chapters/07-managing-issues/README.md)
...
Throughout this book, we use the development of *this very guide* as the running example. Every chapter demonstrates real actions taken in this real repository — so you can see exactly what was done and why.

---

*Built with GitHub + Perplexity. Contributions welcome via Issues and Pull Requests.*
